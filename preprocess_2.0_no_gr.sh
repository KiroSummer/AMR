...
mv ${train_data}.input_clean ${train_data}.input_clean.recategorize.nosense
mv ${dev_data}.input_clean ${dev_data}.input_clean.recategorize.nosense
mv ${test_data}.input_clean ${test_data}.input_clean.recategorize.nosense
