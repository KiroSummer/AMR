...
class WordEncoder(nn.Module):
    def __init__(self, vocabs, char_dim, word_dim, pos_dim, ner_dim, dep_rel_dim,
        ...
        self.tok_embed = AMREmbedding(vocabs['tok'], word_dim, pretrained_file)  # initialize a random embedding @kiro
    ...
    def forward(self, char_input, tok_input, lem_input, pos_input, ner_input, dep_rel_input):
        ...
        tok_repr = self.tok_embed(tok_input)
        reprs = [char_repr, tok_repr]
...
class CNNEncoder(nn.Module):
    def __init__(self, filters, input_dim, output_dim, highway_layers=1):  # [(3, 256)], 32, 128 @kiro
